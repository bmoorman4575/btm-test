var gdjs;
(function(gdjs2) {
  const logger = new gdjs2.Logger("RuntimeScene");
  const setupWarningLogger = new gdjs2.Logger("RuntimeScene (setup warnings)");
  class RuntimeScene {
    ...
    setEventsGeneratedCodeFunction(sceneData) {
      ...
      if (module && module.func) {
        ...
        setupWarningLogger.warn("No function found for running logic of scene " + this._name);
